...
E_D("replace into `ecs_article_cat` values('5','支付方式','5','','','51','0','3','');");
E_D("replace into `ecs_article_cat` values('14','今日聚焦','1','','','2','0','0','');");
E_D("replace into `ecs_article_cat` values('7','配送方式 ','5','','配送与支付 ','54','0','3','');");
E_D("replace into `ecs_article_cat` values('8','售后服务','5','','','55','0','3','');");
E_D("replace into `ecs_article_cat` values('9','关于我们 ','5','','联系我们 ','56','0','3','');");
E_D("replace into `ecs_article_cat` values('10','新手上路','5','','','50','0','3','');");
