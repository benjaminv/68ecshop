...
E_D("replace into `ecs_nav` values('1','','0','新品','1','3','0','search.php?intro=new','middle');");
E_D("replace into `ecs_nav` values('2','','0','预售','1','7','0','pre_sale.php','middle');");
E_D("replace into `ecs_nav` values('3','','0','拍卖','0','9','0','auction.php','middle');");
E_D("replace into `ecs_nav` values('4','','0','团购','1','5','0','pro_search.php?intro=promotion','middle');");
E_D("replace into `ecs_nav` values('5','','0','食品生鲜','0','1','0','search.php?intro=new','middle');");
...
E_D("replace into `ecs_nav` values('9','','0','优品早市','0','15','0','morning_market.php','middle');");
E_D("replace into `ecs_nav` values('10','','0','购物流程','1','2','0','help.php?id=10','top');");
E_D("replace into `ecs_nav` values('11','','0','文章资讯','0','17','0','article_list.php','middle');");
...
E_D("replace into `ecs_nav` values('14','','0','优惠活动','0','14','0','activity.php','middle');");
E_D("replace into `ecs_nav` values('15','','0','关于我们','1','1','1','#','bottom');");
E_D("replace into `ecs_nav` values('16','','0','联系我们','1','2','1','#','bottom');");
...
E_D("replace into `ecs_nav` values('19','','0','站点地图','0','5','0','http://www.chaligou.com/sitemap.xml','bottom');");
E_D("replace into `ecs_nav` values('20','','0','手机商城','1','6','0','#','bottom');");
E_D("replace into `ecs_nav` values('21','','0','销售联盟','1','7','0','#','bottom');");
E_D("replace into `ecs_nav` values('22','','0','商城社区','1','8','1','#','bottom');");
...
E_D("replace into `ecs_nav` values('29','c','1','家居','1','19','0','category.php?id=1','middle');");
