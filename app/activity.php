...
if (!$smarty->is_cached('activity.dwt', $cache_id))
{
	...
	while ($row = $db->fetchRow($res))
	{
		...
		if ($row['act_range'] != FAR_ALL && !empty($row['act_range_ext']))
		{
			...
			{
				$row['page_type'] = 'window';
				$row['page_file'] = 'goods_list';
				$row['page_param'] = 'cat_id';
				$row['page_param_name'] = 'cat_id';
			...
			elseif ($row['act_range'] == FAR_BRAND)
			{
				$row['page_type'] = 'window';
				$row['page_file'] = 'goods_list';
				$row['page_param'] = 'brand_id';
				$row['page_param_name'] = 'brand_id';
			...
			else
			{
				$row['page_type'] = 'window';
				$row['page_file'] = 'goods';
				$row['page_param'] = 'goods_id';
				$row['page_param_name'] = 'goods_id';
