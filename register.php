...
function action_default ()
{
	...
	// 登陆注册-注册类型
	$register_type = empty($_REQUEST['register_type']) ? 'weixin' : $_REQUEST['register_type']; // prince 120029121
	if($register_type != 'email' && $register_type != 'mobile' && $register_type != 'weixin')// prince 120029121
	{
		$register_type = 'weixin';// prince 120029121
	}
