...
$_LANG['cfg_desc']['shop_url'] = '商店绑定域名，包含“http://"  如：http://baidu.com/';
...
$_LANG['cfg_desc']['email_domain'] = '提示：域名之间用“，”隔开（逗号不分全角、半角），域名无须带www<br>参照样式：163.com,palenggege.com';
/* 代码增加_end   By  www.68ecshop.com  */
...
$_LANG['cfg_desc']['what_sms'] = '没有账号？<a target="blank" href="http://yunsms.cn">马上注册云短信</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a target="blank" href="http://www.smsbao.com">马上注册短信宝</a>';
...
/* 代码增加开始 By  palenggege */

 
$_LANG['cfg_name']['dayu'] = '阿里大鱼短信设置';

$_LANG['cfg_name']['appkey'] = 'ACCESSKEY ID';
$_LANG['cfg_name']['secretKey'] = 'ACCESSKEY SECRET'; 
$_LANG['cfg_desc']['appkey'] = '在阿里云信通平台上创建应用即可得到，此插件版权归本站所有';
$_LANG['cfg_name']['dayu_shop_mobile'] = '商家的手机号码';

$_LANG['cfg_name']['dayu_order_placed'] = '客户下订单时是否给商家发短信';
$_LANG['cfg_range']['dayu_order_placed']['1'] = '发短信';
$_LANG['cfg_range']['dayu_order_placed']['0'] = '不发短信';
$_LANG['cfg_name']['dayu_order_placed_tpl'] = '阿里大鱼平台申请的下订单短信模板ID';

 $_LANG['cfg_name']['dayu_zhuce'] = '注册是否发短信';
$_LANG['cfg_range']['dayu_zhuce']['1'] = '发短信';
$_LANG['cfg_range']['dayu_zhuce']['0'] = '不发短信';
$_LANG['cfg_name']['dayu_zhuce_tpl'] = '阿里大鱼平台申请的下验证码短信模板ID';

$_LANG['cfg_name']['dayu_order_pay'] = '客户付款时是否给客户发短信';
$_LANG['cfg_range']['dayu_order_pay']['1'] = '发短信';
$_LANG['cfg_range']['dayu_order_pay']['0'] = '不发短信';
$_LANG['cfg_name']['dayu_order_pay_tpl'] = '付款给客户通知短信模板ID';

$_LANG['cfg_name']['dayu_order_payed'] = '客户付款时是否给商家发短信';
$_LANG['cfg_range']['dayu_order_payed']['1'] = '发短信';
$_LANG['cfg_range']['dayu_order_payed']['0'] = '不发短信';
$_LANG['cfg_name']['dayu_order_payed_tpl'] = '付款给商家通知短信模板ID';

$_LANG['cfg_name']['dayu_order_shipped'] = '商家发货时是否给客户发短信';
$_LANG['cfg_range']['dayu_order_shipped']['1'] = '发短信';
$_LANG['cfg_range']['dayu_order_shipped']['0'] = '不发短信';
$_LANG['cfg_name']['dayu_order_shipped_tpl'] = '发货给客户通知短信模板ID';

$_LANG['cfg_name']['dayu_xiugai'] = '找回密码是否发短信';
$_LANG['cfg_range']['dayu_xiugai']['1'] = '发短信';
$_LANG['cfg_range']['dayu_xiugai']['0'] = '不发短信';
$_LANG['cfg_name']['dayu_xiugai_tpl'] = '找回密码短信模板ID';

$_LANG['cfg_name']['dayu_bangding'] = '会员绑定手机是否发短信';
$_LANG['cfg_range']['dayu_bangding']['1'] = '发短信';
$_LANG['cfg_range']['dayu_bangding']['0'] = '不发短信';
$_LANG['cfg_name']['dayu_bangding_tpl'] = '会员绑定手机短信模板ID';


$_LANG['cfg_name']['dayu_xuni'] = '虚拟卡发货是否发短信';
$_LANG['cfg_range']['dayu_xuni']['1'] = '发短信';
$_LANG['cfg_range']['dayu_xuni']['0'] = '不发短信';
$_LANG['cfg_name']['dayu_xuni_tpl'] = '虚拟卡发货短信模板ID';

$_LANG['cfg_name']['dayu_sign'] = '短信签名';


$_LANG['cfg_name']['thdz'] = '退货维修返回详细地址（包含省市区）';

$_LANG['cfg_name']['thdh'] = '退货收货人电话';


$_LANG['cfg_name']['shxm'] = '退货收货人姓名';



/* 代码增加_end  By  palenggege */
