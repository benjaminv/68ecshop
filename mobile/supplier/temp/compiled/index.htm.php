  ...
  <body>
	...
	<div class="Order">
		...
		<ul>
			...
			<li><a href="order.php?act=list&composite_status=105"><em class="ordem1"><i><?php if ($this->_var['order']['await_receipt']): ?><?php echo $this->_var['order']['await_receipt']; ?><?php else: ?>0<?php endif; ?></i></em><span>待收货</span></a></li>
       ...
       <ul class="border_b">
            <li class="border_r">
            	<a href="goods.php?act=list">
                	<span><img alt="" src="images/n8.png"></span>
                    <p>商品管理</p>
                </a>
            </li>
            <li class="border_r">
            	<a href="goods.php?act=add">
                	<span><img alt="" src="images/n7.png"></span>
                    <p>添加商品</p>
                </a>
            </li>
            <li>
            	<a href="category.php?act=list">
                	<span><img alt="" src="images/n9.png"></span>
                    <p>分类管理</p>
                </a>
            </li>
        </ul>
        <ul class="border_b">
            <li class="border_r">
            	<a href="shop_config.php?act=list_edit">
                	<span><img alt="" src="images/n10.png"></span>
                    <p>店铺设置</p>
                </a>
            </li>
            <li class="border_r">
            	<a href="../supplier.php?suppId=<?php echo $this->_var['supplier_id']; ?>">
                	<span><img alt="" src="images/n3.png"></span>
                    <p>查看店铺</p>
                </a>
            </li>
