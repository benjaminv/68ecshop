...
function sendSms() {
    ...
    //此处需要替换成自己的AK信息
    $accessKeyId = "LTAIu6wHUxVetJ7G";
    $accessKeySecret = "rOwu13IbAfgjaYzy0Vipb93gyoqzQV";
    //短信API产品名
    $product = "Dysmsapi";
    //短信API产品域名
    ...
    //必填-短信接收号码
    $request->setPhoneNumbers("18530181715");
    //必填-短信签名
    $request->setSignName("军翼商城");
    //必填-短信模板Code
    $request->setTemplateCode("SMS_72945045");
    //选填-假如模板中存在变量需要替换则为必填(JSON格式)
    $request->setTemplateParam("{\"number\":\"12345\"}");
    //选填-发送短信流水号
