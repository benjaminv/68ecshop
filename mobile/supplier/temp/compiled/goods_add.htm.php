...
<html>
<head>
<?php echo $this->smarty_insert_scripts(array('files'=>'validator.js,../js/utils.js,tab.js,selectzone_bd.js,transport_bd.js')); ?>
                ...
                <div class="good_info">
                  ...
                  <table width="100%" cellpadding="3" cellspacing="1" >
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="text" id="cat_name" name="cat_name" nowvalue="请选择" value="<?php echo $this->_var['goods_cat_name']; ?>" class="input_good">
          ...
          <div class="good_pd">
            <div class="good">
                <div class="good_info">
                  ...
                  <table width="100%" cellpadding="3" cellspacing="1" >
                    <tr>
                      <td align="left"><span><?php echo $this->_var['lang']['lab_goods_brief']; ?></span></td>
                      <td><textarea name="goods_brief" class="input_good" rows="3" style="height:auto;"><?php echo htmlspecialchars($this->_var['goods']['goods_brief']); ?></textarea>
                      </td>
                    </tr>
                    <tr>
                      <td align="left"><span>商品货号</span></td>
                      <td><input name="goods_sn" type="text" value="<?php echo htmlspecialchars($this->_var['goods']['goods_sn']); ?>" class="input_good"  onblur="checkGoodsSn(this.value,'<?php echo $this->_var['goods']['goods_id']; ?>')" /><br /><span id="goods_sn_notice"></span>
                      </td>
                    </tr>
                    <tr>
                      <td align="left"><span>手机端价</span></td>
                      <td><input name="exclusive" type="text" value="<?php echo $this->_var['goods']['exclusive']; ?>"  class="input_good"/>
                        <br /><span class="notice-span" >为-1的时候表示没有手机专享价格</span></td>
                    </tr>
                    <tr>
                      <td align="left"><span>市场价</span></td>
                      <td><input name="market_price" type="text" value="<?php echo $this->_var['goods']['market_price']; ?>"  class="input_good" style="width:56%;" /><input type="button" value="<?php echo $this->_var['lang']['integral_market_price']; ?>" onclick="integral_market_price()"  style="height:35px;width:30%;" />
                      </td>
                    </tr>
                    
                    
                    <tr>
                        <td align="left"><span><?php echo $this->_var['lang']['lab_goods_brand']; ?></span></td>
                        <td>
                        <select class="input_good" name="brand_id"><option value="0">--请选择--</option><?php echo $this->html_options(array('options'=>$this->_var['brand_list'])); ?></select>
                        </td>
                    </tr>
                    
                  	<!--tr>
                    <td align="left"><span for="is_promote"><input type="checkbox" id="is_promote"  name="is_promote" value="1" <?php if ($this->_var['goods']['is_promote']): ?>checked="checked"<?php endif; ?> onclick="handlePromote(this.checked);" /> <?php echo $this->_var['lang']['lab_promote_price']; ?></span></td>
                    <td align="left"><input type="text" id="promote_1" name="promote_price"  class="input_good" value="<?php echo $this->_var['goods']['promote_price']; ?>"  /></td>
                 	</tr>
                  	<tr id="promote_4">
                    <td align="left" id="promote_5"><span><?php echo $this->_var['lang']['lab_promote_date']; ?></span></td>
                    <td id="promote_6">
                      <input name="promote_start_date" class="input_good" type="text" id="promote_start_date" size="12" value='<?php echo $this->_var['goods']['promote_start_date']; ?>' readonly="readonly" /><br /><input name="selbtn1" type="button" id="selbtn1" onclick="return showCalendar('promote_start_date', '%Y-%m-%d', false, false, 'selbtn1');" value="<?php echo $this->_var['lang']['btn_select']; ?>开始时间" style="height:35px;"/>
                      <br /><input name="promote_end_date" class="input_good" type="text" id="promote_end_date" size="12" value='<?php echo $this->_var['goods']['promote_end_date']; ?>' readonly="readonly" /><br /><input name="selbtn2" type="button" id="selbtn2" onclick="return showCalendar('promote_end_date', '%Y-%m-%d', false, false, 'selbtn2');" value="<?php echo $this->_var['lang']['btn_select']; ?>结束时间" style="height:35px;"/>
                    </td>
                  	</tr-->
                    <tr>
                      <td align="left"><span>分成金额</span></td>
                      <td><input name="cost_price" type="text" value="<?php echo empty($this->_var['goods']['cost_price']) ? '0.00' : $this->_var['goods']['cost_price']; ?>"  class="input_good"/>
                      </td>
                    </tr>
                    <tr>
...
?>
                      <?php echo $this->_var['user_rank']['rank_name']; ?><span id="nrank_<?php echo $this->_var['user_rank']['rank_id']; ?>"></span><input type="text" id="rank_<?php echo $this->_var['user_rank']['rank_id']; ?>" name="user_price[]" value="<?php echo empty($this->_var['member_price_list'][$this->_var['user_rank']['rank_id']]) ? '-1' : $this->_var['member_price_list'][$this->_var['user_rank']['rank_id']]; ?>" onkeyup="if(parseInt(this.value)<-1){this.value='-1';};set_price_note(<?php echo $this->_var['user_rank']['rank_id']; ?>)" size="8" />
                       <input type="hidden" name="user_rank[]" value="<?php echo $this->_var['user_rank']['rank_id']; ?>" /><br />
                       <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                       <span class="notice-span" >为-1时表示会员价格按会员等级折扣率计算</span></td>
                    </tr>
                    <tr>
                        <td align="left"><span><?php echo $this->_var['lang']['lab_volume_price']; ?></span></td>
                        <td>
...
?>
                            <tr>
                              <td>
                                 ...
                                 <br /><?php echo $this->_var['lang']['volume_price']; ?> <input type="text" name="volume_price[]" size="8" value="<?php echo $this->_var['volume_price']['price']; ?>"/>
                              </td>
                            </tr>
                            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                          </table>
                    ...
                    <tr>
                      <td align="left"><span><?php echo $this->_var['lang']['lab_goods_weight']; ?></span></td>
                      <td>
                      <input type="text" name="goods_weight" value="<?php echo $this->_var['goods']['goods_weight_by_unit']; ?>" class="input_good" style="width:56%;"/> <select name="weight_unit" style="width:30%;"><?php echo $this->html_options(array('options'=>$this->_var['unit_list'],'selected'=>$this->_var['weight_unit'])); ?></select>
                      </td>
                    </tr>
                    <tr>
                      <td align="left"><span><?php echo $this->_var['lang']['lab_warn_number']; ?></span></td>
                      <td><input name="warn_number" type="text" value="<?php echo $this->_var['goods']['warn_number']; ?>"  class="input_good"/>
                       <br /><span class="notice-span" >库存告警数量</span>
                      </td>
                    </tr>
                    <tr>
                      <td align="left"><span><?php echo $this->_var['lang']['lab_intro']; ?></span></td>
                      <td>
                    ...
                    <tr>
                      <td align="left"><span><?php echo $this->_var['lang']['lab_is_alone_sale']; ?></span></td>
                      <td><input type="checkbox" name="is_alone_sale" value="1" <?php if ($this->_var['goods']['is_alone_sale']): ?>checked="checked"<?php endif; ?> /> <?php echo $this->_var['lang']['alone_sale']; ?>
                      </td>
                    </tr>
                    <tr>
                      <td align="left"><span><?php echo $this->_var['lang']['lab_is_free_shipping']; ?></span></td>
                      <td><input type="checkbox" name="is_shipping" value="1" <?php if ($this->_var['goods']['is_shipping']): ?>checked="checked"<?php endif; ?> /> <?php echo $this->_var['lang']['free_shipping']; ?>
                      </td>
                    </tr>
                    <tr>
                      <td align="left"><span><?php echo $this->_var['lang']['lab_keywords']; ?></span></td>
                      <td><input type="text" name="keywords" value="<?php echo htmlspecialchars($this->_var['goods']['keywords']); ?>" class="input_good" />
                      </td>
                    </tr>

                    <tr>
                      <td align="left"><span><?php echo $this->_var['lang']['lab_seller_note']; ?></span></td>
                      <td><textarea name="seller_note" class="input_good" rows="3" style="height:auto;"><?php echo $this->_var['goods']['seller_note']; ?></textarea>
                      </td>
                    </tr>
                    <?php if ($this->_var['form_act'] != 'insert'): ?>
                    <tr>
                      <td align="left"><span>审核消息</span></td>
                      <td><textarea name="xxxxyyy" class="input_good" rows="3" style="height:auto;"><?php echo $this->_var['goods']['supplier_status_txt']; ?></textarea>
                      </td>
                    </tr>
                    <?php endif; ?>
                  </table>
