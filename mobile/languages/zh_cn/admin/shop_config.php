...
$_LANG['cfg_name']['pay_fencheng'] = '是否开启付款成功分成';
$_LANG['cfg_range']['pay_fencheng'][1] = '是';
$_LANG['cfg_range']['pay_fencheng'][0] = '否';
$_LANG['cfg_desc']['pay_fencheng'] = '付款成功分成是指客户订单支付成功后自动分成，开启付款成功分成将忽略其他分成方式！';
