...
E_C("CREATE TABLE `ecs_supplier_rebate_log` (
  ...
  `split_money` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '入驻商钱',
...
E_D("replace into `ecs_supplier_rebate_log` values('1','31','2017053158645','1','105.00','21.00','84.00','0.00','3','余额支付','订单支付','1496180643');");
E_D("replace into `ecs_supplier_rebate_log` values('2','51','2017072027854','1','285.00','57.00','218.00','10.00','3','余额支付','订单支付','1500454509');");
E_D("replace into `ecs_supplier_rebate_log` values('3','53','2017072073421','1','285.00','57.00','218.00','10.00','3','余额支付','订单支付','1500456271');");
