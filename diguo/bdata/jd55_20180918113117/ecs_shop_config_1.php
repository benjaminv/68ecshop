...
E_D("replace into `ecs_shop_config` values('19','0','dayu','group','','','','1');");
E_D("replace into `ecs_shop_config` values('9','0','wap','hidden','','','','1');");
E_D("replace into `ecs_shop_config` values('101','1','shop_name','text','','','多用户网络商城','0');");
E_D("replace into `ecs_shop_config` values('102','1','shop_title','text','','','多用户网络商城','1');");
E_D("replace into `ecs_shop_config` values('103','1','shop_desc','text','','','网络商城','1');");
E_D("replace into `ecs_shop_config` values('104','1','shop_keywords','text','','','ecshop小京东插件','1');");
...
E_D("replace into `ecs_shop_config` values('107','1','shop_city','manual','','','222','1');");
E_D("replace into `ecs_shop_config` values('108','1','shop_address','text','','','合肥火车站','1');");
E_D("replace into `ecs_shop_config` values('109','1','qq','text','','','1234567','1');");
...
E_D("replace into `ecs_shop_config` values('114','1','service_email','text','','','1234567@qq.com','1');");
E_D("replace into `ecs_shop_config` values('115','1','service_phone','text','','','18888888888','1');");
E_D("replace into `ecs_shop_config` values('116','1','shop_closed','select','0,1','','0','1');");
E_D("replace into `ecs_shop_config` values('117','1','close_comment','textarea','','','网站升级中','1');");
...
E_D("replace into `ecs_shop_config` values('202','2','icp_number','text','','','沪ICP备20154100号','1');");
...
E_D("replace into `ecs_shop_config` values('211','2','integral_scale','text','','','100','1');");
E_D("replace into `ecs_shop_config` values('212','2','integral_percent','text','','','1','1');");
E_D("replace into `ecs_shop_config` values('213','2','sn_prefix','text','','','CLG','1');");
...
E_D("replace into `ecs_shop_config` values('226','2','cron_method','select','0,1','','1','1');");
...
E_D("replace into `ecs_shop_config` values('313','3','history_number','text','','','6','1');");
...
E_D("replace into `ecs_shop_config` values('330','3','search_keywords','text','','','功能插件,支付插件,模板,设计服务,天猫评论区','0');");
...
E_D("replace into `ecs_shop_config` values('410','4','order_pay_note','select','1,0','','0','1');");
...
E_D("replace into `ecs_shop_config` values('501','5','smtp_host','text','','','','1');");
E_D("replace into `ecs_shop_config` values('502','5','smtp_port','text','','','','1');");
...
E_D("replace into `ecs_shop_config` values('604','6','template','hidden','','','pc_paleng_moban','1');");
E_D("replace into `ecs_shop_config` values('605','6','install_date','hidden','','','1469243200','1');");
...
E_D("replace into `ecs_shop_config` values('616','6','affiliate','hidden','','','a:3:{s:6:\"config\";a:7:{s:6:\"expire\";d:24;s:11:\"expire_unit\";s:4:\"hour\";s:11:\"separate_by\";i:0;s:15:\"level_point_all\";s:3:\"10%\";s:15:\"level_money_all\";s:3:\"50%\";s:18:\"level_register_all\";i:2;s:17:\"level_register_up\";i:60;}s:4:\"item\";a:3:{i:0;a:2:{s:11:\"level_point\";s:3:\"50%\";s:11:\"level_money\";s:3:\"50%\";}i:1;a:2:{s:11:\"level_point\";s:3:\"30%\";s:11:\"level_money\";s:3:\"30%\";}i:2;a:2:{s:11:\"level_point\";s:2:\"7%\";s:11:\"level_money\";s:2:\"7%\";}}s:2:\"on\";i:1;}','1');");
E_D("replace into `ecs_shop_config` values('617','6','captcha','hidden','','','3','1');");
...
E_D("replace into `ecs_shop_config` values('1032','8','sms_register','select','1,0','','1','17');");
E_D("replace into `ecs_shop_config` values('1031','8','sms_order_shipped','select','1,0','','0','9');");
E_D("replace into `ecs_shop_config` values('1030','8','sms_order_payed','select','1,0','','0','5');");
E_D("replace into `ecs_shop_config` values('1029','8','sms_order_placed','select','1,0','','0','4');");
...
E_D("replace into `ecs_shop_config` values('990','9','shop_name_goodscart1','hidden','','','coolhong_','1');");
...
E_D("replace into `ecs_shop_config` values('998','10','supplier_notice','textarea','','','尊敬的供货商您好，欢迎您使用怕冷哥哥多商户系统！','245');");
E_D("replace into `ecs_shop_config` values('999','10','supplier_rebate_paytype','textarea','','','支付宝转账\r\n银行转账\r\n微信支付\r\n财付通转账','250');");
E_D("replace into `ecs_shop_config` values('150','1','erweima_wapurl','text','','','http://jd6.web5.youxueshop.com/mobile/goods.php?id={id}','1');");
...
E_D("replace into `ecs_shop_config` values('1003','3','email_domain','textarea','','','163.com,palenggege.com','1');");
...
E_D("replace into `ecs_shop_config` values('298','2','time_shouhuo','text','','','12','1');");
...
E_D("replace into `ecs_shop_config` values('1028','8','sms_shop_mobile','text','','','18878797008','3');");
E_D("replace into `ecs_shop_config` values('1026','2','fulltext_search','select','1,0','','0','1');");
E_D("replace into `ecs_shop_config` values('1027','10','supplier_comment','select','0,1','','0','2');");
E_D("replace into `ecs_shop_config` values('1033','8','sms_goods_stockout','select','1,0','','0','13');");
E_D("replace into `ecs_shop_config` values('1034','8','sms_order_placed_tpl','textarea','','','您有一条新订单，订单号为：%s，请注意查看。【%s】','4');");
E_D("replace into `ecs_shop_config` values('1035','8','sms_order_payed_tpl','textarea','','','客户已付款，订单号为：%s，请注意查看。【%s】','6');");
E_D("replace into `ecs_shop_config` values('1036','8','sms_sign','text','','','茶立购','3');");
E_D("replace into `ecs_shop_config` values('1037','8','sms_goods_stockout_tpl','textarea','','','您登记的商品%s已经到货，您可点击下面链接直接进入商品页面浏览或购买！%s【%s】','14');");
E_D("replace into `ecs_shop_config` values('1038','8','sms_order_pay','select','1,0','','0','7');");
E_D("replace into `ecs_shop_config` values('1039','8','sms_order_pay_tpl','textarea','','','您已付款，订单号为：%s【%s】','8');");
E_D("replace into `ecs_shop_config` values('1040','8','sms_order_shipped_tpl','textarea','','','您的订单已发货，订单号为%s，收货人为%s，收货地址为%s，请注意查收【%s】','10');");
E_D("replace into `ecs_shop_config` values('1041','8','sms_pricecut','select','1,0','','0','11');");
E_D("replace into `ecs_shop_config` values('1042','8','sms_pricecut_tpl','textarea','','','您关注的商品%s已经降价，您可点击下面链接直接进入商品页面浏览或购买！%s【%s】','12');");
E_D("replace into `ecs_shop_config` values('1043','8','sms_change_password','select','1,0','','1','15');");
E_D("replace into `ecs_shop_config` values('1044','8','sms_change_password_tpl','textarea','','','您于%s修改了登录密码，密码已修改成功！如果不是您本人操作，请及时联系商城客服。【%s】','16');");
E_D("replace into `ecs_shop_config` values('1045','8','sms_register_tpl','textarea','','','您的验证码为：%s【%s】','18');");
E_D("replace into `ecs_shop_config` values('1046','8','sms_user_money_change','select','1,0','','1','19');");
E_D("replace into `ecs_shop_config` values('1047','8','sms_use_balance_reduce_tpl','textarea','','','您于%s在商城消费%s元，当前余额：%s元。如有疑问，请联系商城客服。【%s】','20');");
E_D("replace into `ecs_shop_config` values('1048','8','sms_deposit_balance_reduce_tpl','textarea','','','您于%s在商城申请提现%s元，提现已成功，当前余额：%s元。如有疑问，请联系商城客服。【%s】','21');");
E_D("replace into `ecs_shop_config` values('1049','8','sms_recharge_balance_add_tpl','textarea','','','恭喜您，已成功充值%s元，当前余额：%s元。如有疑问，请联系商城客服。【%s】','22');");
E_D("replace into `ecs_shop_config` values('1050','8','sms_admin_operation_tpl','textarea','','','商城于%s调节您的余额%s元，当前余额%s元。如有疑问，请联系商城客服。【%s】','23');");
E_D("replace into `ecs_shop_config` values('1051','8','sms_return_goods_tpl','textarea','','','您提交的退货申请已成功处理，退回款项：%s元，当前余额：%s元。如有疑问，请联系商城客服。【%s】','24');");
E_D("replace into `ecs_shop_config` values('11','0','chat','group','','','','1');");
E_D("replace into `ecs_shop_config` values('1052','8','ecsdxt_user_name','text','','','chaligou','1');");
E_D("replace into `ecs_shop_config` values('1053','8','ecsdxt_pass_word','password','','','clg123456','2');");
E_D("replace into `ecs_shop_config` values('12','0','app','hidden','','','APP设置','1');");
E_D("replace into `ecs_shop_config` values('1054','12','push_setting','manual','','','a:1:{i:0;a:3:{s:8:\"app_name\";s:12:\"集选优品\";s:7:\"app_key\";s:24:\"418c7d3e134c56f1dab54d41\";s:10:\"app_secret\";s:24:\"e1d31855d3cc97ab2fe66173\";}}','1');");
E_D("replace into `ecs_shop_config` values('1055','12','guide_picture','manual','','','a:3:{i:0;s:30:\"app/images/guide_picture_0.jpg\";i:1;s:30:\"app/images/guide_picture_1.jpg\";i:2;s:30:\"app/images/guide_picture_2.jpg\";}','1');");
E_D("replace into `ecs_shop_config` values('1056','12','menu_setting','manual','','','a:10:{i:0;a:5:{s:5:\"image\";s:21:\"app/images/menu_0.png\";s:4:\"name\";s:9:\"店铺街\";s:4:\"type\";s:4:\"page\";s:4:\"link\";s:6:\"stores\";s:5:\"order\";s:1:\"1\";}i:1;a:5:{s:5:\"image\";s:21:\"app/images/menu_1.png\";s:4:\"name\";s:12:\"全部品牌\";s:4:\"type\";s:4:\"page\";s:4:\"link\";s:10:\"brand_list\";s:5:\"order\";s:1:\"2\";}i:2;a:5:{s:5:\"image\";s:21:\"app/images/menu_2.png\";s:4:\"name\";s:12:\"限时抢购\";s:4:\"type\";s:4:\"page\";s:4:\"link\";s:12:\"promote_list\";s:5:\"order\";s:1:\"3\";}i:3;a:5:{s:5:\"image\";s:21:\"app/images/menu_3.png\";s:4:\"name\";s:12:\"优惠活动\";s:4:\"type\";s:4:\"page\";s:4:\"link\";s:8:\"activity\";s:5:\"order\";s:1:\"4\";}i:4;a:5:{s:5:\"image\";s:21:\"app/images/menu_4.png\";s:4:\"name\";s:12:\"我的关注\";s:4:\"type\";s:7:\"article\";s:4:\"link\";s:1:\"1\";s:5:\"order\";s:1:\"6\";}i:5;a:5:{s:5:\"image\";s:21:\"app/images/menu_5.png\";s:4:\"name\";s:12:\"我的资金\";s:4:\"type\";s:4:\"page\";s:4:\"link\";s:12:\"user_account\";s:5:\"order\";s:1:\"7\";}i:6;a:5:{s:5:\"image\";s:21:\"app/images/menu_6.png\";s:4:\"name\";s:12:\"文章资讯\";s:4:\"type\";s:4:\"page\";s:4:\"link\";s:11:\"article_cat\";s:5:\"order\";s:1:\"8\";}i:7;a:5:{s:5:\"image\";s:21:\"app/images/menu_7.png\";s:4:\"name\";s:12:\"联系电话\";s:4:\"type\";s:5:\"phone\";s:4:\"link\";s:10:\"4000785268\";s:5:\"order\";s:1:\"9\";}i:8;a:5:{s:5:\"image\";s:21:\"app/images/menu_8.png\";s:4:\"name\";s:12:\"手机专享\";s:4:\"type\";s:4:\"page\";s:4:\"link\";s:9:\"exclusive\";s:5:\"order\";s:1:\"5\";}i:9;a:5:{s:5:\"image\";s:21:\"app/images/menu_9.png\";s:4:\"name\";s:12:\"在线客服\";s:4:\"type\";s:4:\"page\";s:4:\"link\";s:4:\"chat\";s:5:\"order\";s:2:\"10\";}}','1');");
E_D("replace into `ecs_shop_config` values('1057','12','menu_per_row','text','','','5','1');");
E_D("replace into `ecs_shop_config` values('1058','12','goods_per_row','text','','','3','1');");
E_D("replace into `ecs_shop_config` values('1059','12','android_app_version','text','','','01.01.0001','1');");
E_D("replace into `ecs_shop_config` values('1060','12','ios_app_version','text','','','01.01.0001','1');");
E_D("replace into `ecs_shop_config` values('1061','12','phone_login','select','0,1','','1','1');");
E_D("replace into `ecs_shop_config` values('1062','12','template_setting','manual','','','a:11:{s:3:\"ad1\";a:6:{s:4:\"name\";s:10:\"广告位1\";s:5:\"order\";s:1:\"0\";s:6:\"number\";s:1:\"4\";s:4:\"show\";s:2:\"on\";s:4:\"type\";s:2:\"ad\";s:5:\"value\";s:3:\"100\";}s:4:\"menu\";a:5:{s:4:\"name\";s:12:\"菜单列表\";s:5:\"order\";s:1:\"1\";s:6:\"number\";s:2:\"12\";s:4:\"show\";s:2:\"on\";s:5:\"value\";N;}s:13:\"promote_goods\";a:5:{s:4:\"name\";s:12:\"今日秒杀\";s:5:\"order\";s:1:\"2\";s:6:\"number\";s:1:\"9\";s:4:\"show\";s:2:\"on\";s:5:\"value\";N;}s:3:\"ad2\";a:6:{s:4:\"name\";s:10:\"广告位2\";s:5:\"order\";s:1:\"3\";s:6:\"number\";s:1:\"3\";s:4:\"show\";s:2:\"on\";s:4:\"type\";s:2:\"ad\";s:5:\"value\";s:3:\"101\";}s:3:\"ad3\";a:6:{s:4:\"name\";s:10:\"广告位3\";s:5:\"order\";s:1:\"4\";s:6:\"number\";s:1:\"3\";s:4:\"show\";s:2:\"on\";s:4:\"type\";s:2:\"ad\";s:5:\"value\";s:3:\"102\";}s:9:\"new_goods\";a:5:{s:4:\"name\";s:12:\"新品上市\";s:5:\"order\";s:1:\"5\";s:6:\"number\";s:1:\"9\";s:4:\"show\";s:2:\"on\";s:5:\"value\";N;}s:9:\"hot_goods\";a:5:{s:4:\"name\";s:12:\"热卖商品\";s:5:\"order\";s:1:\"6\";s:6:\"number\";s:1:\"9\";s:4:\"show\";s:2:\"on\";s:5:\"value\";N;}s:3:\"ad4\";a:6:{s:4:\"name\";s:10:\"广告位4\";s:5:\"order\";s:1:\"7\";s:6:\"number\";s:1:\"3\";s:4:\"show\";s:2:\"on\";s:4:\"type\";s:2:\"ad\";s:5:\"value\";s:3:\"103\";}s:9:\"goods_cat\";a:6:{s:4:\"name\";s:18:\"分类下的商品\";s:5:\"order\";s:1:\"8\";s:6:\"number\";s:2:\"12\";s:4:\"show\";s:2:\"on\";s:4:\"type\";s:9:\"goods_cat\";s:5:\"value\";s:1:\"5\";}s:11:\"goods_brand\";a:6:{s:4:\"name\";s:18:\"品牌下的商品\";s:5:\"order\";s:1:\"9\";s:6:\"number\";s:1:\"9\";s:4:\"show\";s:2:\"on\";s:4:\"type\";s:5:\"array\";s:5:\"value\";N;}s:10:\"best_goods\";a:5:{s:4:\"name\";s:12:\"猜你喜欢\";s:5:\"order\";s:2:\"10\";s:6:\"number\";s:2:\"15\";s:4:\"show\";s:2:\"on\";s:5:\"value\";N;}}','1');");
E_D("replace into `ecs_shop_config` values('1063','12','app_template','text','','','default','1');");
E_D("replace into `ecs_shop_config` values('1065','8','what_sms','select','0,1','','1','0');");
E_D("replace into `ecs_shop_config` values('99','0','kuaidi100','group','','','','1');");
E_D("replace into `ecs_shop_config` values('1064','99','kuaidi100_api','text','','','c6f8602bc9eb3c2c','0');");
E_D("replace into `ecs_shop_config` values('100','1','shop_url','text','','','http://jd6.noonet.cn/','1');");
E_D("replace into `ecs_shop_config` values('20000','11','chat_server_ip','text','','','127.0.0.1','1');");
E_D("replace into `ecs_shop_config` values('20001','11','chat_server_port','text','','','9090','1');");
E_D("replace into `ecs_shop_config` values('20002','11','chat_http_bind_port','text','','','7070','1');");
E_D("replace into `ecs_shop_config` values('20003','11','chat_server_admin_username','text','','','admin','1');");
E_D("replace into `ecs_shop_config` values('20004','11','chat_server_admin_password','password','','','111111','1');");
E_D("replace into `ecs_shop_config` values('2000','19','appkey','text','','','LTAIu6wHUxVetJ7G','1');");
E_D("replace into `ecs_shop_config` values('2001','19','secretKey','password','','','rOwu13IbAfgjaYzy0Vipb93gyoqzQV','1');");
E_D("replace into `ecs_shop_config` values('2002','19','dayu_shop_mobile','text','','','18530181714','1');");
E_D("replace into `ecs_shop_config` values('2003','19','dayu_order_placed','select','1,0','','0','5');");
E_D("replace into `ecs_shop_config` values('2004','19','dayu_order_payed','select','1,0','','0','7');");
E_D("replace into `ecs_shop_config` values('2005','19','dayu_order_shipped','select','1,0','','0','9');");
E_D("replace into `ecs_shop_config` values('2006','19','dayu_order_placed_tpl','text','','','SMS_8500141','6');");
E_D("replace into `ecs_shop_config` values('2007','19','dayu_order_payed_tpl','text','','','SMS_8540093','8');");
E_D("replace into `ecs_shop_config` values('2008','19','dayu_order_pay','select','1,0','','0','11');");
E_D("replace into `ecs_shop_config` values('2009','19','dayu_order_pay_tpl','text','','','SMS_8540093','12');");
E_D("replace into `ecs_shop_config` values('2011','19','dayu_sign','text','','','军翼商城','1');");
E_D("replace into `ecs_shop_config` values('2012','19','dayu_zhuce','select','1,0','','1','1');");
E_D("replace into `ecs_shop_config` values('2013','19','dayu_zhuce_tpl','text','','','SMS_75835007','2');");
E_D("replace into `ecs_shop_config` values('2010','19','dayu_order_shipped_tpl','text','','','SMS_8495149','10');");
E_D("replace into `ecs_shop_config` values('2014','19','dayu_xiugai','select','1,0','','1','13');");
E_D("replace into `ecs_shop_config` values('2015','19','dayu_xiugai_tpl','text','','','SMS_28260022','14');");
E_D("replace into `ecs_shop_config` values('2016','19','dayu_bangding','select','1,0','','0','15');");
E_D("replace into `ecs_shop_config` values('2017','19','dayu_bangding_tpl','text','','','SMS_8980689','16');");
E_D("replace into `ecs_shop_config` values('2018','19','dayu_xuni','select','1,0','','0','17');");
E_D("replace into `ecs_shop_config` values('2019','19','dayu_xuni_tpl','text','','','SMS_28110025','18');");
E_D("replace into `ecs_shop_config` values('20005','1','thdz','text','','','安徽省合肥市包河区','1');");
E_D("replace into `ecs_shop_config` values('20006','1','thdh','text','','','18888888888','1');");
E_D("replace into `ecs_shop_config` values('20007','1','shxm','text','','','陈光','1');");
