...
$GLOBALS['smarty']->assign('goods_name',           $goods['goods_name']);
		    $GLOBALS['smarty']->assign('shop_price',           $goods['shop_price']);
		    $GLOBALS['smarty']->assign('shop_name',           $_GET['shop_name']);
/* 记录浏览历史 */
...
$db->autoExecute($ecs->table('jilu'), $row, 'INSERT');
