 ...
 * 演示地址: http://palenggege.com  开发QQ:120029121    309485552
 * ----------------------------------------------------------------------------
...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
   ...
   //早市
	...
	$is_morning_market = $_REQUEST['is_morning_market'];
	$morning_market_price = $_REQUEST['morning_market_price'];
	//手机专享价格 app   jx 
    ...
    if ($is_insert)
    {
        if ($code == '')
        {
            $sql = "INSERT INTO " . $ecs->table('goods') . " (goods_name, goods_name_style, ghost_count, goods_sn,morning_market_price,is_morning_market, " .
                ...
                "VALUES ('$_POST[goods_name]', '$goods_name_style', '$ghost_count', '$goods_sn','$morning_market_price','$is_morning_market', '$catgory_id', " .
    ...
    else
    {
        ...
        $sql .= "keywords = '$_POST[keywords]', " .
                ...
                "last_update = '". gmtime() ."', ".
				"is_morning_market = '$is_morning_market', " .
				"morning_market_price = '$morning_market_price'," .
                "goods_type = '$goods_type' " .
                "WHERE goods_id = '$_REQUEST[goods_id]' LIMIT 1";
    }
    $db->query($sql);
	
			/*---------如果该商品分成金额大于0  自动成为分销商品-----------*/
            if ($cost_price > 0 and $is_distrib_goods == 1 )     
				...
				value (0,0,0,'$cost_price',1,'$is_distrib_goods_id ')";
...
elseif ($_REQUEST['act'] == 'drop_goods')
{
    ...
    $db->query($sql);
	 ...
	 $sql = "DELETE FROM " . $ecs->table('ecsmart_distrib_goods') . " WHERE goods_id = '$goods_id'";
    $db->query($sql);
