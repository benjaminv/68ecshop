...
$_LANG['cfg_name']['shop_district'] = '所在县区';
...
$_LANG['cfg_name']['wechat'] = '客服微信号码';
$_LANG['cfg_name']['wechat_qrcode'] = '客服微信二维码';
...
$_LANG['cfg_desc']['shop_url'] = '商店绑定域名，包含“http://"  如：http://demo.coolhong.com/';
...
$_LANG['gzip_confirm'] = "GZip 功能需要您的服务器支持 zlib 扩展库。\\n如果您发现开启Gzip后页面出现乱码，可能是您的服务器已经开启了Gzip，您不需要在 QQ120029121 中再次开启。";
...
$_LANG['cfg_desc']['email_domain'] = '提示：域名之间用“，”隔开（逗号不分全角、半角），域名无须带www<br>参照样式：163.com,demo.coolhong.com';
/* 代码增加_end   By  demo.coolhong.com 今天优品 多商户系统 QQ 120-029-121  */
/* 晒单插件  添加 by demo.coolhong.com 今 天 优 品 多 商 户 系 统 q q 1 2 0 0 2 9 1 2 1 */
...
/*增值税发票_添加_END_demo.coolhong.com*/


$_LANG['cfg_name']['sms'] = '短信设置';

$_LANG['cfg_name']['what_sms'] = '短信接口提供商';
$_LANG['cfg_range']['what_sms']['0'] = '云短信';
$_LANG['cfg_range']['what_sms']['1'] = '短信宝';
$_LANG['cfg_range']['what_sms']['2'] = '阿里大鱼短信';
$_LANG['cfg_name']['what_sms_tpl'] = '';

$_LANG['cfg_desc']['what_sms'] = '没有账号？<a target="blank" href="http://yunsms.cn">马上注册云短信</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a target="blank" href="http://www.smsbao.com">马上注册短信宝</a></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a target="blank" href="http://www.alidayu.com/">马上注册大鱼短信</a>';

$_LANG['cfg_name']['dx_user_name'] = '短信服务账户';
$_LANG['cfg_desc']['dx_user_name'] = '短信服务商提供的供系统发送短信所需要的账户或阿里大鱼AppKey';

$_LANG['cfg_name']['dx_pass_word'] = '短信服务密码';
$_LANG['cfg_desc']['dx_pass_word'] = '短信服务商提供的供系统发送短信所需要的密码或阿里大鱼AppSecret';
...
$_LANG['cfg_name']['sms_order_placed_dayu'] = '大鱼短信模板ID';
$_LANG['cfg_desc']['sms_order_placed_dayu'] = '提示：短信模板必须是在阿里大鱼“管理中心-短信模板管理”中的可用模板。示例：SMS_585014</br>阿里大鱼平台上申请模板格式：您有一条新订单，订单号为：${code}，请注意查看。';
...
$_LANG['cfg_name']['sms_order_pay_dayu'] = '大鱼短信模板ID';
$_LANG['cfg_desc']['sms_order_pay_dayu'] = '提示:短信模板必须是在阿里大鱼“管理中心-短信模板管理”中的可用模板。示例:SMS_585014</br>阿里大鱼平台上申请模板格式：您已付款，订单号为：${code}。';
...
$_LANG['cfg_name']['sms_order_payed_dayu'] = '大鱼短信模板ID';
$_LANG['cfg_desc']['sms_order_payed_dayu'] = '提示:短信模板必须是在阿里大鱼“管理中心-短信模板管理”中的可用模板。示例:SMS_585014</br>阿里大鱼平台上申请模板格式：客户已付款，订单号为：${code}，请注意查看。';
...
$_LANG['cfg_name']['sms_order_shipped_dayu'] = '大鱼短信模板ID';
$_LANG['cfg_desc']['sms_order_shipped_dayu'] = '提示:短信模板必须是在阿里大鱼“管理中心-短信模板管理”中的可用模板。示例:SMS_585014</br>阿里大鱼平台上申请模板格式：您的订单已发货，订单号为：${code}，收货人为${consignee}，收货地址为${address}，请注意查收';
...
$_LANG['cfg_name']['sms_register_dayu'] = '大鱼短信模板ID';
$_LANG['cfg_desc']['sms_register_dayu'] = '提示:短信模板必须是在阿里大鱼“管理中心-短信模板管理”中的可用模板。示例:SMS_585014</br>阿里大鱼平台上申请模板格式：您的验证码为：${code},打死也不要告诉别人。';
...
$_LANG['cfg_name']['sms_goods_stockout_dayu'] = '大鱼短信模板ID';
$_LANG['cfg_desc']['sms_goods_stockout_dayu'] = '提示:短信模板必须是在阿里大鱼“管理中心-短信模板管理”中的可用模板。示例:SMS_585014</br>阿里大鱼平台上申请模板格式：您登记的商品${code}已经到货，请及时下单购买。';
...
$_LANG['cfg_name']['sms_pricecut_dayu'] = '大鱼短信模板ID';
$_LANG['cfg_desc']['sms_pricecut_dayu'] = '提示:短信模板必须是在阿里大鱼“管理中心-短信模板管理”中的可用模板。示例:SMS_585014</br>阿里大鱼平台上申请模板格式：您关注的商品${code}已经降价，要把握机会哦！！';
...
$_LANG['cfg_name']['sms_change_password_dayu'] = '大鱼短信模板ID';
$_LANG['cfg_desc']['sms_change_password_dayu'] = '提示:短信模板必须是在阿里大鱼“管理中心-短信模板管理”中的可用模板。示例:SMS_585014</br>阿里大鱼平台上申请模板格式：您于${code}修改了登录密码，密码已修改成功！如果不是您本人操作，请及时联系商城客服。';
...
$_LANG['cfg_name']['pay_rem_sms_qq309485552_tpl'] = '计划任务=>订单提醒付款短信';




$_LANG['cfg_name']['kuaidi100'] = '快递100API';

$_LANG['cfg_name']['kuaidi100_api'] = '快递100API';
$_LANG['cfg_desc']['kuaidi100_api'] = '快递100提供的供系统查询快递状态的api
没有API？<a target="blank" href="http://www.kuaidi100.com/openapi/">马上申请</a>';

/*fulltext_search_add_START_demo.coolhong.com*/
$_LANG['cfg_name']['fulltext_search'] = '全文搜索引擎';
$_LANG['cfg_range']['fulltext_search']['0'] = '关闭';
$_LANG['cfg_range']['fulltext_search']['1'] = '开启';
/*fulltext_search_add_END_demo.coolhong.com*/

/* 代码增加_注册红包start  By  demo.coolhong.com 今天优品 多商户系统 QQ 120-029-121 */
...
/* 代码增加_注册红包end  By  demo.coolhong.com 今天优品 多商户系统 QQ 120-029-121 */

$_LANG['cfg_name']['shop_opint'] = '店铺坐标';
$_LANG['cfg_name']['deposit_least_money'] = '每次提现现金的最低金额';


/*寒冰   qq  309485552   小票打印机*/

$_LANG['cfg_name']['printer'] = '小票打印机设置';
$_LANG['cfg_name']['printer_open'] = '开启打印机';
$_LANG['cfg_range']['printer_open']['1'] = '开启';
$_LANG['cfg_range']['printer_open']['0'] = '关闭';
$_LANG['cfg_desc']['printer_open'] = '说明：开启服务需要购买专业打印机。没有打印机？<a target="blank" href="https://shop35115209.taobao.com/">点此购买</a>';
$_LANG['cfg_name']['printer_user'] = '打印机账户';
$_LANG['cfg_name']['printer_key'] = '打印机秘钥';
$_LANG['cfg_name']['printer_sn'] = '打印机编号';
$_LANG['cfg_name']['custom_lang'] = '页脚自定义';
$_LANG['cfg_desc']['custom_lang'] = '说明：设置自定义打印语，将显示在小票页脚位置';


/*今天优品  寒冰QQ  309  48  5552     商家分配二级域名*/
$_LANG['cfg_name']['supplier_url_open'] = '是否开启入驻商二级域名分配';
$_LANG['cfg_range']['supplier_url_open']['1'] = '开启';
$_LANG['cfg_range']['supplier_url_open']['0'] = '关闭';
$_LANG['cfg_desc']['supplier_url_open'] = '开启后，入驻商家可以设置自己的个性二级域名，访问自己的店铺。使用该功能，请先将域名进行泛解析。';
$_LANG['cfg_name']['use_url'] = '自留域名前缀：';
$_LANG['cfg_desc']['use_url'] = '用户将无法申请使用平台自留域名前缀，多个用英文半角逗号隔开。';
$_LANG['cfg_name']['supplier_url'] = '店铺二级域名';
$_LANG['cfg_name']['use_supplier_url'] = '二级域名前缀';
$_LANG['cfg_desc']['use_supplier_url'] = '设置二级域名前缀，可以使用个性二级域名快速访问店铺';
?>