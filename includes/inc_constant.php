...
define('CART_CUT_GOODS',            8); // 砍价活动
define('CART_EXTPINTUAN_GOODS',     10); // 新版拼团
define('CART_LUCKY_BUY_GOODS',     12); // 云购活动
...
define('PS_REFUNDED',               3); // 已退款   怕冷哥哥  QQ497401495
...
define('GAT_CUT',                   8); // 砍价活动
define('GAT_EXTPINTUAN',            10); // 新版拼团
define('GAT_LUCKY_BUY',               12); // 云购
