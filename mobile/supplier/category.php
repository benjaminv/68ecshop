...
/**
 * QQ120029121 商品分类管理程序
 * ============================================================================
 * 演示地址: http://demo.coolhong.com  开发QQ:120029121    309485552
 * ============================================================================
 * $Author: PRINCE $
 * $Id: category.php 17217 2017-04-01 06:29:08Z PRINCE $
*/
...
if ($_REQUEST['act'] == 'list')
{
    ...
    _wap_assign_header_info('商品分类','商品分类',0,1);
    _wap_assign_footer_order_info();
    _wap_display_page('category_list.htm');
...
//    $smarty->assign('action_link',  array('href' => 'category.php?act=list', 'text' => $_LANG['03_category_list']));
    ...
    _wap_assign_header_info('添加商品分类','添加商品分类',0,1);
    _wap_assign_footer_order_info();
    _wap_display_page('category_info.htm');
}
...
if ($_REQUEST['act'] == 'insert')
{
    ...
    if ($db->autoExecute($ecs->table('supplier_category'), $cat) !== false)
    {
		...
		*/
        ...
        $link[1]['href'] = 'category.php?act=add';
