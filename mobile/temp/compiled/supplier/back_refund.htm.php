...
<table>
  ...
  <tr>
    ...
    <th>退款方式：</th>
    <td>
	<p><label><input type="radio" name="refund_type" value="1"  />退回用户余额</label><br>      <label><input type="radio" name="refund_type" value="2" checked=checked />线下退款</label><br>   <label><input type="radio" name="refund_type" value="4" checked=checked />微信原路退款</label><br>   
    </p>
	</td>
  </tr>
  <tr>
