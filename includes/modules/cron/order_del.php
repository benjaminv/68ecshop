...
$cron_lang_www_ecshop68_com = ROOT_PATH . 'languages/' .$GLOBALS['_CFG']['lang']. '/cron/order_del_qq_497401495.php';
...
if (isset($set_modules) && $set_modules == TRUE)
{
    ...
    /* 描述对应的语言项 */
    $modules[$i]['desc']    = 'order_del_qq_497401495_desc';
    ...
    $modules[$i]['config']  = array(
        array('name' => 'order_del_qq_497401495_day', 'type' => 'select', 'value' => '1'),
		array('name' => 'order_del_qq_497401495_action', 'type' => 'select', 'value' => '2'),
    );

    return;
}

$cron['order_del_qq_497401495_day'] = !empty($cron['order_del_qq_497401495_day'])  ?  $cron['order_del_qq_497401495_day'] : 1 ;
$deltime = gmtime() - $cron['order_del_qq_497401495_day'] * 3600 * 24;

$cron['order_del_qq_497401495_action'] = !empty($cron['order_del_qq_497401495_action'])  ?  $cron['order_del_qq_497401495_action'] : 'invalid' ;
//echo $cron['order_del_qq_497401495_action'];
...
{
  if ($cron['order_del_qq_497401495_action'] == 'cancel' || $cron['order_del_qq_497401495_action'] == 'invalid')
  {
	  /* 设置订单为取消 */
	  if ($cron['order_del_qq_497401495_action'] == 'cancel')
	  {
	  ...
	  /* 设置订单未无效 */
	  elseif($cron['order_del_qq_497401495_action'] == 'invalid')
	  {
  ...
  elseif ($cron['order_del_qq_497401495_action'] == 'remove')
  {
	  /* 删除订单 */
