...
E_D("replace into `ecs_ecsmart_shop_config` values('101','1','shop_name','text','','','多用户商城','1');");
E_D("replace into `ecs_ecsmart_shop_config` values('102','1','shop_title','text','','','多用户商城','1');");
E_D("replace into `ecs_ecsmart_shop_config` values('103','1','shop_desc','text','','','多用户商城','1');");
E_D("replace into `ecs_ecsmart_shop_config` values('104','1','shop_keywords','text','','','ecshop','1');");
E_D("replace into `ecs_ecsmart_shop_config` values('115','1','service_phone','text','','','18888888888','1');");
E_D("replace into `ecs_ecsmart_shop_config` values('921','911','distrib_style','select','1,0','','0','2');");
...
E_D("replace into `ecs_ecsmart_shop_config` values('918','911','reserve_money','text','','','100','1');");
...
E_D("replace into `ecs_ecsmart_shop_config` values('318','3','price_format','select','0,1,2,3,4,5','','0','1');");
...
E_D("replace into `ecs_ecsmart_shop_config` values('330','3','search_keywords','text','','','功能插件,模板,支付插件,设计服务,天猫评论区','0');");
...
E_D("replace into `ecs_ecsmart_shop_config` values('501','5','smtp_host','text','','','','1');");
E_D("replace into `ecs_ecsmart_shop_config` values('502','5','smtp_port','text','','','','1');");
E_D("replace into `ecs_ecsmart_shop_config` values('503','5','smtp_user','text','','','','1');");
E_D("replace into `ecs_ecsmart_shop_config` values('504','5','smtp_pass','password','','','','1');");
E_D("replace into `ecs_ecsmart_shop_config` values('505','5','smtp_mail','text','','','','1');");
...
E_D("replace into `ecs_ecsmart_shop_config` values('604','6','template','hidden','','','mo_paleng_moban','1');");
...
E_D("replace into `ecs_ecsmart_shop_config` values('616','6','affiliate','hidden','','','a:3:{s:6:\"config\";a:13:{s:6:\"expire\";d:0;s:11:\"expire_unit\";N;s:11:\"separate_by\";i:0;s:15:\"level_point_all\";d:0;s:15:\"level_money_all\";d:0;s:18:\"level_register_all\";i:0;s:17:\"level_register_up\";i:0;s:9:\"parent_id\";N;s:15:\"ex_fenxiao_flag\";N;s:19:\"ex_fenxiao_personal\";s:1:\"1\";s:20:\"level_money_personal\";d:5;s:20:\"level_point_personal\";d:5;s:20:\"personal_lever_money\";s:2:\"30\";}s:4:\"item\";a:2:{i:0;a:2:{s:11:\"level_point\";s:3:\"80%\";s:11:\"level_money\";s:3:\"40%\";}i:1;a:2:{s:11:\"level_point\";s:3:\"15%\";s:11:\"level_money\";s:3:\"35%\";}}s:2:\"on\";i:1;}','1');");
E_D("replace into `ecs_ecsmart_shop_config` values('617','6','captcha','hidden','','','1','1');");
...
E_D("replace into `ecs_ecsmart_shop_config` values('917','911','deposit_least_money','text','','','200','1');");
E_D("replace into `ecs_ecsmart_shop_config` values('916','911','distrib_percent','text','','','10','1');");
...
E_D("replace into `ecs_ecsmart_shop_config` values('912','911','distrib_rank','manual','','','0','1');");
...
E_D("replace into `ecs_ecsmart_shop_config` values('930','911','pay_fencheng','select','1,0','','0','1');");
