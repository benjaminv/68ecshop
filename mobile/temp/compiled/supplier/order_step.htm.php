...
?>
  <tr>
	...
	<!--  //手机专享价格 app  -->
	<td><input name="exclusive[]" type="text" style="text-align:right" value="<?php echo $this->_var['goods']['exclusive']; ?>" size="10" />
	 <!--  //手机专享价格 app  -->
...
?>
  ...
  <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
  <?php if ($this->_var['pickup_point_list']): ?>
	<tr>
    <th width="5%">&nbsp;</th>
...
?>
  <tr>
    <td><input name="pickup_point" type="radio" value="<?php echo $this->_var['shipping']['id']; ?>" <?php if ($this->_var['order']['pickup_point'] == $this->_var['shipping']['id']): ?>checked<?php endif; ?> onclick="" /></td>
    <td><?php echo $this->_var['shipping']['shop_name']; ?></td>
    <td colspan="4">地址:<?php echo $this->_var['shipping']['address']; ?>&nbsp;&nbsp;联系人:<?php echo $this->_var['shipping']['contact']; ?>&nbsp;&nbsp;联系方式:<?php echo $this->_var['shipping']['phone']; ?></td>
    </tr>
  <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
  <tr>
  <?php endif; ?>
...
?>
  <tr>
    <td><input name="pickup_point" type="radio" value="<?php echo $this->_var['shipping']['id']; ?>" <?php if ($this->_var['order']['pickup_point'] == $this->_var['shipping']['id']): ?>checked<?php endif; ?> onclick="" /></td>
    <td><?php echo $this->_var['shipping']['shop_name']; ?></td>
    <td>地址:<?php echo $this->_var['shipping']['address']; ?>&nbsp;&nbsp;联系人:<?php echo $this->_var['shipping']['contact']; ?>&nbsp;&nbsp;联系方式:<?php echo $this->_var['shipping']['phone']; ?></td>
    </tr>
  <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
  <tr>
  <?php endif; ?>
