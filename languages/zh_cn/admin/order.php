...
$_LANG['cs'][81] = '拼团'; // PRINCE
$_LANG['cs'][82] = '拼团中'; // PRINCE
$_LANG['cs'][83] = '拼团成功'; // PRINCE
$_LANG['cs'][84] = '拼团成功待抽奖'; // PRINCE
$_LANG['cs'][85] = '拼团成功待发货'; // PRINCE
$_LANG['cs'][86] = '拼团失败'; // PRINCE
$_LANG['cs'][87] = '拼团待退款'; // PRINCE
$_LANG['cs'][88] = '已退款'; // PRINCE
...
$_LANG['ps'][PS_REFUNDED] = '已退款';   // 怕冷哥哥  QQ497401495
...
$_LANG['org_wx_refund'] = '原路退回（仅支持微信支付，非微信支付方式付款请勿选择）';  // PRINCE 120029121

$_LANG['org_wx_refund_note'] = '注意：款项将直接退回给客户，该操作不可逆。请谨慎操作。'; // PRINCE 120029121
