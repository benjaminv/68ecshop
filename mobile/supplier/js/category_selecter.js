...
(function($){
	...
	$.showCategorySelecter = function(catNameObj, catIdObj, zNodes, selectedId, lang_cat_expand_all, lang_cat_collect_all, lang_cat_expand, lang_cat_collect)
	{
		...
		var menuHtml = "<div id='"+menuContent_id+"' class='menuContent' style='display: none; position: absolute; background-color: white; border: 1px black solid;'>"
		    ...
		    +"<input type='button' id='"+btn_expand_all_id+"' value='"+lang_cat_expand_all+"' style='padding: 5px 15px 5px;margin: 2px 2px;	border: none;background: #FF0000;color: #FFF;cursor: pointer;'>"
		    +"<input type='button' id='"+btn_expand_id+"' value='"+lang_cat_expand+"' style='padding: 5px 15px 5px;margin: 2px 2px;	border: none;background: #FF0000;color: #FFF;cursor: pointer;'>"
		    +"<input type='button' id='"+btn_collect_id+"' value='"+lang_cat_collect+"' style='padding: 5px 15px 5px;margin: 2px 2px;	border: none;background: #FF0000;color: #FFF;cursor: pointer;'>"
		    +"</div>"
