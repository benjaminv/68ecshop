 ...
 * ============================================================================
 * $Author: wanganlin $
 * $Id: alipay.php 17217 2014-02-13 16:29:08Z wanganlin $
 */
...
class alipay
{
    ...
    function get_code($order, $payment)
    {
        ...
        $req_data = '<direct_trade_create_req>'
                ...
                . '<notify_url>'.$GLOBALS['ecs']->url().'pay/huidiao.php'.'</notify_url>'
        ...
        $zfb_url=$gateway.$param. '&sign='.md5($sign);


		$zfb_url=urlencode($zfb_url);
   


        $url=$GLOBALS['ecs']->url().'pay/alipay_weixin.php?code='.$zfb_url;


        /************************生成支付链接**************************/
        
        $button = '<div class="pay-btn">
		
		<input type="button" onclick="window.location.href=\''.$url.'\'" value="立即使用支付宝支付" class="sub_btn"/>
	 ...
	 * 取得返回信息地址
	 */
	function return_alipay_url()
	{
		return $GLOBALS['ecs']->url() . 'notify/alipay.php';
	}
