 ...
 * 判断如果是智能手机访问的话 跳转到手机版对应页面 方法
 *
 * @access  public
 */
function pc_to_mobile()
{
    //判断是否是手机访问   QQ   3 0 948  555  2 
    $is_mobile = false;
    ...
    if($is_mobile){
        ...
        if ($filename != 'index')
        {
                ...
                if ('goods' == $filename)
                {
                    if(!empty($_GET['id'])){
					    if(!empty($_GET['u'])){
						 $Loaction = $mobile_url .'/goods.php?u='.$_GET['u'].'&id='.$_GET['id'];
						}else{
						 $Loaction = $mobile_url .'/goods.php?&id='.$_GET['id'];
						}
                ...
                /* 团购 */
                 elseif ('pro_search' == $filename)
                {
                    if(!empty($_GET['encode'])){
                        $Loaction = $mobile_url .'/pro_search.php?&encode='.$_GET['encode'];
                    }else{
                        $Loaction = $mobile_url .'/pro_search.php?';
                    }
                }
                /* 拍卖 */
                elseif ('auction' == $filename)
                {
                    if(!empty($_GET['id'])){
                        $Loaction = $mobile_url .'/auction.php?act=view&id='.$_GET['id'];
                    }else{
                        $Loaction = $mobile_url .'/auction.php?';
                    }
                }
                /* 预售 */
                elseif ('pre_sale' == $filename)
                {
                    if(!empty($_GET['id'])){
                        $Loaction = $mobile_url .'/pre_sale.php?&id='.$_GET['id'];
                    }else{
                        $Loaction = $mobile_url .'/pre_sale?';
                    }
                }
                /* 批发 */
                elseif ('wholesale' == $filename)
                {
                    if(!empty($_GET['id'])){
                        $Loaction = $mobile_url .'/wholesale.php?&id='.$_GET['id'];
                    }else{
                        $Loaction = $mobile_url .'/';
                    }
                }
                ...
                {
                    if(!empty($_GET['id'])){
                        $Loaction = $mobile_url .'/exchange.php?&id='.$_GET['id'].'&act=view';
                    }else{
                        $Loaction = $mobile_url .'/exchange.php?';
                    }
                }
				 /*文章详情*/
                elseif ('article_cat' == $filename)
                {
                    if(!empty($_GET['id'])){
                        $Loaction = $mobile_url .'/article_cat.php?&id='.$_GET['id'];
                    }
                }
				
				 elseif ('article' == $filename)
                {
                    if(!empty($_GET['id'])){
                        $Loaction = $mobile_url .'/article.php?&id='.$_GET['id'];
                    }
                }
                /* 优惠活动 */
                elseif ('activity' == $filename)
                {
                    $Loaction = $mobile_url .'/activity.php?';
                }
				 /* 店铺街 */
                elseif ('stores' == $filename)
                {
                    $Loaction = $mobile_url .'/stores.php?';
                }
