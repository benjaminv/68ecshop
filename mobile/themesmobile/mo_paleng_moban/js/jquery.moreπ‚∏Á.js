(function($) {
	...
	var methods = {
		...
		get_data: function() {
           ...
           if(sessionStorage['last'+settings.leixing]&&settings.scroll == 'false'){
            ...
            if(sessionStorage['last'+settings.leixing]&&settings.scroll == 'true'){



                           variables.last= sessionStorage['last'+settings.leixing]+10;
